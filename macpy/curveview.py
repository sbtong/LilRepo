...
def main():
    from maclab import logutils
    from maclab import dbutils  
    print "Running: " + os.path.abspath(os.curdir) + "\\CurveControl.py"
    parser = OptionParser()
    logutils.LogConfigurator.add_option_argument(parser)
    dbutils.DatabaseConfigurator.add_option_argument(parser)

    (options, _ ) = parser.parse_args()

    logutils.LogConfigurator.configure_logger(options)
    dbutils.DatabaseConfigurator.configure_databse(options)
